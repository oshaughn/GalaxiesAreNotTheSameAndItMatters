...
supernova.    For Type II supernovae, iron and oxygen are produced according to the analytic fits used in \citet{Raiteri96} using the yields from \citet{Woosley95}:
...
\cite{2016arXiv160508783L} and others.  Since prior population synthesis investigations  extend relatively smoothly to very metallicity, we do not introduce a
...
In our investigation, we have neglected the impact of population III stars.
...
\citep{2016MNRAS.460L..74H,2016PhRvL.117f1101S,2014MNRAS.442.2963K}.  
