...
$^4$Department of Physics, Grinnell College, Grinnell, IA, 50112, USA\\
$^5$Institute of Astronomy, University of Cambridge, Cambridge CB3 OHA, UK\\
...
In \S \ref{sec:sims}, we describe detailed hydrodynamical simulations of  several galaxies, including four of Milky Way-mass and two dwarfs.  Though the four Milky Way-mass galaxies are morphologically similar at $z = 0$, we
...
including large-scale torques from cosmic structure.  Our cosmological parameters are $\Omega_0 = 0.24$, $\Omega_{\rm baryon} = 0.04$, $\Lambda = 0.76$, h = 0.73, $\sigma_8 = 0.77$ 
 \citep{WMAP3} and we model the ionizing UV background
...
newly-born stars with greater metallicity.  When these two galaxies are $2-3\unit{Gyr}$ old, prior to the first major
...
$(r_{D}/M)_{\BoringGalaxy{}}/(r_{D}/M)_{\ExcitingGalaxy{}}\simeq 0.9$.    \jillianremark{\bf RICHARD this is 0.1 in my calcuations}  
...
However, it is also possible that this close agreement is entirely a numerical coincidence between the specific star formation rate and metallicities in these two galaxies.  The effects described here
