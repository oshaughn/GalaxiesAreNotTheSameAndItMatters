...
the sky position and therefore approximate birthplace of each merging binary \cite{Nissanke13}.    
%
...
properties. \jillianremark{ UPDATE}   We also demonstrate that even the coalescence rates of binary neutron stars (NSNS) and black hole-neutron
...
$\dot{M}_*$ and metallicity distribution $p(\log Z|t)$ over time.
...
V)_{\ExcitingGalaxy{}} \simeq 7$.    \jillianremark{ UPDATE} However, in this same epoch, the star formation rate in the \ExcitingGalaxy{} (lower-metallicity)
...
The close agreement between the two galaxies' binary black hole populations \jillianremark{ UPDATE} is entirely a
...
On the other hand, particularly during the epoch of galaxy formation, galaxies are well-mixed: stars and adjacent gas generally do not have similar chemical composition.  These mixing effects have been previously recognized as an obstacle to interpreting transient event spectra.  For
...
For binary black hole mergers in particular, we show that the present-day binary black hole coalescence rate can vary by factors of several \jillianremark{ UPDATE} in otherwise
