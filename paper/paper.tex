...
and chemical evolution histories \editremark{citation: need better ones} \citep[see,e.g.][]{2009MNRAS.396..462K,2014MNRAS.444..336C, Dalcanton09,Williams11,CALIFA}. \jillianremark{Do you want citations of GRB host observations or just general galaxy stuff?}
...
%\editremark{recheck numbers: we are tweaking things, and Zsun is seemingly inconsistent in the two approaches }
 ...
 times.  
However, at early times, the exciting galaxy forms stars for $\simeq 2\unit{Gyr}$ at a lower characteristic metallicity
($Z\simeq 0.8 \times10^{-3}$) compared
to the boring galaxy ($Z\simeq 2\times 10^{-3}$).  In this reigme, the formation efficiency $\lambda$ and sensitive volume $V$
can depend sensitively on mass; for example, for binary black holes, the ratio of  $(\lambda V)_{boring}/(\lambda
V)_{exciting} \simeq 7$.    However, in this same epoch, the star formation rate in the exciting (low-metallicity)
...
$r_{D,boring}/r_{D,exciting}=\textbf{ZZZ}$.    
...
exceptionally large fraction of low-metallicity star formation in their history.  The precise details of their chemical
...
\begin{tabular}{|ll|l|}\hline
 \text{Boring} & \text{BHBH} & 1.05 \\
 \text{Exciting} & \text{BHBH} & 1.11 \\
 \text{Dwarf1} & \text{BHBH} & 3.14 \\
 \text{Dwarf2} & \text{BHBH} & 10.3 \\ \hline
 \text{Boring} & \text{NSNS} & 0.000425 \\
 \text{Exciting} & \text{NSNS} & 0.000513 \\ \hline
 \text{Boring} & \text{BHNS} & 0.00162 \\
 \text{Exciting} & \text{BHNS} & 0.00195 \\
 \text{Dwarf1} & \text{BHNS} & 0.00217 \\
 \text{Dwarf2} & \text{BHNS} & 0.00182\\  \hline
\end{tabular}
\end{centering}
...
similar present-day environments.   Our calculations supports and extends prior investigations which demonstrated both
that black hole merger rates depend sensitively on low-metallicitiy environments
\cite{PSellipticals,popsyn-LowMetallicityImpact2b-StarTrackRevised-2013,gwastro-EventPopsynPaper-2016}.   More broadly,
...
\cite{2016arXiv160508783L}.     More broadly, our analysis reflect  similar theoretical studies performed in the interpretation of, for
