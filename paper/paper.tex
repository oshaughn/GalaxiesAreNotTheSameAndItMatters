...
a numerical coincdence between the specific star formation rate and metallicities in these two galaxies.  The effects described here
  ...
  present-day properties.   \editremark{Do we have more examples?}
...
\hline
\hline
 \text{\BoringGalaxy} & 0.012  &0.000219 & 0.000206 & $4.24 \times 10^{10}$ \\
 \text{\ExcitingGalaxy}  & 0.0116 & 0.000264 &   0.000228 & $4.46 \times 10^{10}$ \\
 \text{\DwarfOne} & 0.0207  & 0.000275 &  & $7.8 \times 10^9$ \\
 \text{\DwarfTwo}  & 0.0524 & 0.000235  &  & $2.5 \times 10^8$ \\
\hline
\end{tabular}
\end{centering}
...
short GRBs \citep{2010ApJ...725.1202L}
 and
  SN Ia \citep{2011MNRAS.412.1508M}; see, e.g., the review in  \cite{2014ARAA..52...43B}.  \jillianremark{RICHARD THIS LAST PARAGRAPH IS STILL SUPER CONFUSE TO ME SORRY.  I think you need to call me and tell me about this response function so I can reword into normalpeople language}
%
...
histories and binary formation models.  \jillianremark{ new, important!}  Now that we have introduced this method as a proof-of-concept here, it can be applied to large volume simulations, such as Illustris, EAGLE, or Romulus, in order to examine large numbers of galaxies and thus obtain statistically significant results.
