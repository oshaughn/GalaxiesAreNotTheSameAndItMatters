...
($Z\simeq 0.8 10^{-3}$) compared
to the borinng galaxy ($Z\simeq 2\times 10^{-3}$).  In this reigme, the formation efficiency $\lambda$ and sensitive volume $V$
can depend sensitively on mass; for example, for binary black holes, the ratio of  $(\lambda V)_{boring}/(\lambda
V)_{exciting} \simeq 7$.
...
present-day coalescing binary black holes in our two galaxies is expected to differ by as much as a factor of \textbf{YYY (=2?)}.  
%
Using the concrete phenomenological calculations described above, we in fact find
$r_{D,boring}/r_{D,exciting}=\textbf{ZZZ}$.  

The origin of the differenc
