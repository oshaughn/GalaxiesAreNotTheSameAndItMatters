...
Binary evolution calculations suggest the binary compact object formation rate rate depends sensitively on the assumed metallicity, in conjuction
...
% POINT: 
To characterize how often compact binaries form and coalesc
