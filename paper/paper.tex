...
\citet{Thielemann86} respectively.  {\bf Richard:
 We adopt a fiducial Salpeter IMF.  We do not introduce a special group of Population III stars (??).
 As described in ZZZ, the  derived cosmological metal evolution and star formation rate history derived using this
 procedure is broadly consistent with the cosmological star formation history and metallicity evolution of the universe.
 In particular, our procedure is broadly consistent with one of the \cite{2016MNRAS.461.3877D} models
}
