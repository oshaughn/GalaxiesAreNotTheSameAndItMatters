...
\section{Model for electromagnetic counterparts}
...
%
\jillianremark{Grammatical nightmare ahead: }Stellar evolution and hence supernovae remnants are expected to evolve
...
%
Figure \ref{fig:TidalDisrupt} shows contours of this expression for different values of $\theta_{LS}$.  \jillianremark{Add a sentence here describing the significance of the plot.  e.g. low-mass BHs can have a range of spins, regardless of angle, but high mass BHs always get high spins yay.}
